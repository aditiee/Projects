...
<body>
	<nav class="navbar navbar-expand d-flex flex-column align-item-start"
		...
		<ul class="navbar-nav d-flex flex-column mt-5 w-100">
	  	...
	  	<li class="nav-item w-100"><a href="<%=request.getContextPath()%>/list1"
		...
		<div class="header">
			...
			<div class="row">
				...
				<div class="container" style="margin-top: 20px">
					<h3 class="text-center"><a href="<%=request.getContextPath()%>/list1">List of Students</a></h3>
							...
							<c:forEach var="user" items="${listUser}">
								...
								<tr>
									...
									<td>
										...
										<a href="delete1?userId=<c:out value='${user.userId}' />">Delete</a>
									</td>
								</tr>
							</c:forEach>
