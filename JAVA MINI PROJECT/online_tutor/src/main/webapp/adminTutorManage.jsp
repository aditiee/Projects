			...
			<div class="row">
				...
				<div class="container">
					<h3 class="text-center">
						<a href="<%=request.getContextPath()%>/list">List of Tutors</a>
					</h3>
						...
						<tbody>
							...
							<c:forEach var="user" items="${listUser}">
								...
								<tr>
									...
									<td><c:out value="${user.mobile-no}" /></td>
									<td><a
										href="listContent?userId=<c:out value='${user.userId}' />">view</a></td>
									<td><a
										href="studentlist?userId=<c:out value='${user.userId}' />">view</a></td>
									<td><a
										href="delete?userId=<c:out value='${user.userId}' />">delete</a>
									</td>
								</tr>
							</c:forEach>
							<!-- } -->
