	...
	<nav class="navbar navbar-expand d-flex flex-column align-item-start"
		...
		<ul class="navbar-nav d-flex flex-column mt-5 w-100">
			<ul class="navbar-nav d-flex flex-column mt-5 w-100">
				...
				<li class="nav-item w-100"><a
					href="approveRequestDashboard.jsp" class="nav-link text-light pl-4">Approve
		...
		<div class="row">
			...
			<div class="container">
				<h3 class="text-center">
					<a href="<%=request.getContextPath()%>/tutor">Approval List of
						Tutor</a>
				</h3>
				<hr>
					...
					<tbody>
						...
						<c:forEach var="user" items="${listUser}">
							...
							<tr>
								...
								<td><a href="updatetutor?id=<c:out value='${user.id}' />">Approve</a>

									<a href="deletetutor?id=<c:out value='${user.id}' />">Reject</a>
								</td>
							</tr>
						</c:forEach>
						<!-- } -->
